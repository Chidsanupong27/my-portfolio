const experiences = [
  {
    ...
    company: "The Siam Cement (Thung Song) Co., Ltd.",
    description:
      "Developed internal web applications for the MRO-TS department, including systems for job management, cost estimation, and procurement. Built frontend using React and backend using PHP, while working with databases and system workflows.",
    technologies: ["React", "PHP", "SQL", "Tailwind CSS"],
    current: true,
  },
  {
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6 animate-fade-in animation-delay-100 text-secondary-foreground">
            Experience that{" "}
            <span className="font-serif itatic font-normal text-white">
              speaks volumes.
            </span>
          </h2>
        ...
        <div className="relative">
          <div className="timeline-glow absolute left-0 md:left-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-primary/70 via-primary/30 to-transparent md:-translate-x-1/2:shadow-[0_0_25pxrgba(32,178,166,0.8)]" />
