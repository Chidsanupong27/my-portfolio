...
const testimonials = [
  {
    quote:
      "Gained hands-on experience building enterprise web applications at SCG Thung Song, contributing to real systems that support business operations.",
    author: "SCG Thung Song",
    role: "Full-Stack Developer",
    avatar: "/projects/Scg-logo.png",
  },
  {
    quote:
  ...
  {
    quote:
      "Awarded 2nd Runner-up in PSU Pitching 2025 for developing the Quadash business platform.",
    author: "Prince of Songkla University",
    role: "Award Achievement",
    avatar: "/projects/psu-logo.jpg",
  },
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            <div className="glass p-8 rounded-3xl md:p-12 glow-border animate-fade-in animation-delay-200">
              ...
              <div className="flex items-center gap-4">
                <img
                  ...
                  className="w-15 h-15 rounded-full object-cover ring-2 ring-primary/20"
                />
                <div>
            ...
            {/* Testimonails navigation*/}
            <div className="flex items-center justify-center gap-4 mt-8">
              <button
                className="p-3 rounded-full glass hover:bg-primary/10 hover:text-primary transitio-all "
                onClick={previous}
              >
                <ChevronLeft />
              </button>
